...
export function middleware(request: NextRequest) {
  // The logic here is temporarily disabled to prevent a redirect loop.
  // The current authentication uses localStorage, which is inaccessible by server-side middleware.
  // A future implementation will use secure HTTP-only cookies.
